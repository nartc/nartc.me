...
<p>
    ...
    />
    <em>
        Screenshot 1. Bundle size of <code>FooModule</code>,{" "}
        <code>BarModule</code>, and <code>SharedModule</code>
    </em>
</p>
...
<p>
    ...
    />
    <em>
        Screenshot 2. Bundle size of <code>FooModule</code>,{" "}
        <code>BarModule</code>, <code>SharedAModule</code>, and{" "}
        <code>SharedBModule</code>
    </em>
</p>
...
<p>
    ...
    />
    <em>
        Screenshot 3. Bundle size of <code>FooModule</code> and{" "}
...
<p>
    ...
    />
    <em>
        Screenshot 4. Bundle size of <code>FooModule</code>,{" "}
        <code>BarModule</code>, and <code>FormsModule</code>
    </em>
</p>
