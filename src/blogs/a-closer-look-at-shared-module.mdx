...
<p>
    <Image src={sharedModuleOne} format="avif" alt='A screenshot showing bundlesize of FooModule, BarModule, and SharedModule' height={500}/>
...
<p>
    <Image src={sharedModuleTwo} format="avif" alt='A screenshot showing bundlesize of FooModule, BarModule, with two SCAMs' height={500}/>
...
<p>
    <Image src={sharedModuleThree} format="avif" alt='A screenshot showing bundlesize of FooModule and FormsModule' height={500}/>
    <em>Screenshot 3. Bundle size of <code>FooModule</code> and <code>FormsModule</code></em>
</p>

<p>
    <Image src={sharedModuleFour} format="avif" alt='A screenshot showing bundlesize of FooModule, BarModule, and FormsModule' height={500}/>
