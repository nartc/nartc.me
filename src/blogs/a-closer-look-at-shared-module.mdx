...
<p>
    <Picture widths={[960]} src={sharedModuleOne} alt='A screenshot showing bundlesize of FooModule, BarModule, and SharedModule' height={500}/>
    <em>Screenshot 1. Bundle size of <code>FooModule</code>, <code>BarModule</code>, and <code>SharedModule</code></em>
</p>
...
<p>
    <Picture widths={[960]} src={sharedModuleTwo} alt='A screenshot showing bundlesize of FooModule, BarModule, with two SCAMs' height={500}/>
    <em>Screenshot 2. Bundle size of <code>FooModule</code>, <code>BarModule</code>, <code>SharedAModule</code>, and <code>SharedBModule</code></em>
</p>
...
<p>
    <Picture widths={[960]} src={sharedModuleThree} alt='A screenshot showing bundlesize of FooModule and FormsModule' height={500}/>
    <em>Screenshot 3. Bundle size of <code>FooModule</code> and <code>FormsModule</code></em>
</p>

<p>
    <Picture widths={[960]} src={sharedModuleFour} alt='A screenshot showing bundlesize of FooModule, BarModule, and FormsModule' height={500}/>
    <em>Screenshot 4. Bundle size of <code>FooModule</code>, <code>BarModule</code>, and <code>FormsModule</code></em>
</p>
